...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendEmailVerificationWithContinueUrl() {
        ...
        String url = "http://www.adball.online/verify?uid=" + user.getUid();
    ...
    public void sendPasswordReset() {
        ...
        FirebaseAuth auth = FirebaseAuth.getInstance();
        String emailAddress = "mail@adball.online";
    ...
    public void reauthenticate() {
        ...
        AuthCredential credential = EmailAuthProvider
                .getCredential("mail@adball.online", "Maliek#01");
    ...
    public void buildActionCodeSettings() {
        ...
        ActionCodeSettings actionCodeSettings =
                ActionCodeSettings.newBuilder()
                        // URL you want to redirect back to. The domain (www.adball.online) for this
                        // URL must be whitelisted in the Firebase Console.
                        .setUrl("https://www.adball.online/finishSignUp?cartId=1234")
                        // This must be true
                        .setHandleCodeInApp(true)
                        .setIOSBundleId("online.adball.ios")
                        .setAndroidPackageName(
                                "online.adball.android",
